...
func ReadDataType(context *parsing.Context) parsing.EntityPtr {
	...
	// TOSCA 1.1 doesn't support the "EntrySchema" field (introduced in TOSCA 1.3)
	context.SetReadTag("EntrySchema", "")
	// TOSCA 1.1 doesn't support the "Units" field (introduced in TOSCA 2.0)
	context.SetReadTag("Units", "")
	// TOSCA 1.1 doesn't support the "Prefixes" field (introduced in TOSCA 2.0)
